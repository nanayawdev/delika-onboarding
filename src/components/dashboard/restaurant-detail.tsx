  ...
  return (
    <div className="min-h-screen bg-white p-4 md:p-8 mt-12">
      <div className="flex items-center justify-between mb-6">
        ...
        >
          <SelectTrigger className="w-[300px] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
      ...
      <div className="max-w-9xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="border border-gray-200 overflow-hidden h-[300px] restaurant-hero">
                ...
                <div className="flex justify-between items-start">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        className="h-8 w-8 p-0 text-gray-100 hover:bg-white/10"
                      >
          ...
          <Card className="border border-gray-200 h-[300px] overflow-auto">
            ...
            <CardContent className="p-4">
              {isLoadingUsers ? (
                ...
                <div className="text-center py-6">
                  ...
                  <p className="text-xs text-gray-500 mb-3">This restaurant hasn't added any users yet.</p>
                  <Button 
                    onClick={() => setIsAddUserModalOpen(true)}
                    size="sm"
                    variant="outline"
                    className="gap-2 border border-gray-200 shadow-none hover:bg-gray-50"
                  >
              ...
              <Card className="border border-blue-200 bg-blue-50">
                <CardContent className="p-4 flex flex-col justify-between h-full">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xl font-medium text-gray-600">Total Users</span>
                  </div>
              ...
              <Card className="border border-blue-200 bg-blue-50">
                <CardContent className="p-4 flex flex-col justify-between h-full">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xl font-medium text-gray-600">Branches</span>
                  </div>
                  <div className="text-3xl font-semibold text-gray-900">{branches.length}</div>
                </CardContent>
              </Card>
            </div>
              ...
              <Card className="border border-green-200 bg-green-50">
                <CardContent className="p-4 flex flex-col justify-between h-full">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xl font-medium text-gray-600">Total Sales</span>
                  </div>
                  <div className="text-3xl font-semibold text-gray-900">
              ...
              <Card className="border border-rose-200 bg-rose-50">
                <CardContent className="p-4 flex flex-col justify-between h-full">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-xl font-medium text-gray-600">Delivery Sales</span>
                  </div>
                  <div className="text-3xl font-semibold text-gray-900">
          ...
          <CardContent className="p-6">
            {isLoading ? (
              ...
              <ErrorState 
                ...
                description="We couldn't load the branches for this restaurant. This might be due to a network issue or the server being temporarily unavailable."
                primaryAction={{
                  label: "Try Again",
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {branches.map((branch) => (
                    <Card 
                      key={branch.id}
                      className={`cursor-pointer transition-all border border-gray-200 ${
                    ...
                    >
                      <CardContent className="p-4">
                        ...
                        <p className="text-sm text-gray-500">{branch.branchPhoneNumber}</p>
                      </CardContent>
                    </Card>
                  ))}
                </div>
                  ...
                  <Card className="mt-6">
                    ...
                    <CardContent>
                      {isLoadingOrders ? (
                        ...
                        <div className="text-center py-8">
                          <p className="text-gray-500">No orders found for this branch</p>
                        </div>
                      ) : (
                        <Table>
                          <TableHeader>
